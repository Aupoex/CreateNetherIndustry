...
public class ThinSoulFluidType extends AllFluids.TintedFluidType {
    ...
    private ThinSoulFluidType(Properties properties, ResourceLocation stillTexture, ResourceLocation flowingTexture) {
    ...
    public static FluidBuilder.FluidTypeFactory create() {
        return (properties, stillTexture, flowingTexture) -> {
            return new ThinSoulFluidType(properties, stillTexture, flowingTexture);
        };
    }
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            ...
            public ResourceLocation getStillTexture() {
                ...
                ResourceLocation stillRL = ThinSoulFluidType.this.originalStillTextureRL;
                return stillRL;
            }

            @Override
            public ResourceLocation getFlowingTexture() {
                ResourceLocation newFlowingRL = CreateNetherIndustry.asResource("fluid/thin_soul_fluid_flowing");
                return newFlowingRL;
            }

            @Override
            public int getTintColor(FluidStack stack) {
                return ThinSoulFluidType.this.getTintColor(stack);
            }

            @Override
            public int getTintColor(FluidState state, BlockAndTintGetter getter, BlockPos pos) {
                return ThinSoulFluidType.this.getTintColor(state, getter, pos);
            }
            ...
            public void modifyFogRender(Camera camera, FogRenderer.FogMode mode, float renderDistance, float partialTick,
                ...
                float modifier = ThinSoulFluidType.this.getFogDistanceModifier();
